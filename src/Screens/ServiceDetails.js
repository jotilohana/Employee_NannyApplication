    ...
    return (
      <View style={styles.textView}>
        <Text style={{color: 'black'}}>
          ...
          a sample of fonts, enerate text for testing, or to spoof an e-mail
          spam filter.{' '}
        </Text>
      </View>
    );
      ...
      <View style={styles.barView}>
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            setPressedReview(false);
          }}>
          <Text style={pressedAbout ? styles.barTextOnclick : styles.barText}>
            About
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          onPress={() => {
            setShowReview(true);
            setShowAbout(false);
            setPressedReview(true);
            setPressedAbout(false);
          }}>
          <Text style={pressedReview ? styles.barTextOnclick : styles.barText}>
            Review
          </Text>
        </TouchableOpacity>
      </View>
